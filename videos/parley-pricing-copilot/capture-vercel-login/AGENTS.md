...
Source: https://parley-pricing-copilot-laurent-maxhunis-projects.vercel.app
...
| `extracted/tokens.json` | Design tokens: 7 colors, 2 fonts, 1 headings, 1 CTAs |
...
- **Colors**: #FAFAFA (bg-light), #171717 (surface-dark), #EBEBEB (bg-light), #FFFFFF (bg-light), #0072F5 (accent), #000000 (bg-dark), #A8A8A8 (neutral)
- **Fonts**: Geist Mono (100-900 variable), GeistSans (100-900 variable)
